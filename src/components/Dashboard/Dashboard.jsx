...
const Dashboard = () => {
  ...
  const handleButtonClick = (buttonIndex) => {
    setSelectedButton(buttonIndex); // Actualizar el botón seleccionado
  };
          ...
          <section className="section">
            ...
            <nav className="menu admin-menu">
              <button className="menu-button active">
                ...
                <span>Inicio</span>
                <img className="arrow" src={FlechaNegra} alt="Ir" />
              </button>
              <button className="menu-button disabled">
                <img src={Lotes} alt="Lotes" />
                <span>Lotes</span>
                <img className="arrow" src={FlechaGris} alt="Ir" />
              </button>
              <button className="menu-button disabled">
